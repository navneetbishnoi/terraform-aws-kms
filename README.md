...
[![CI](https://github.com/navneetbishnoi/terraform-aws-kms/actions/workflows/ci.yml/badge.svg)](https://github.com/navneetbishnoi/terraform-aws-kms/actions/workflows/ci.yml)

> 🌩️ **A production-grade, reusable AWS Kms module by [navneetbishnoi](https://www.navneetbishnoi.com)**
...
- ✅ Seamless integration with other **navneetbishnoi Terraform modules**
...
```hcl
module "kms_key" {
  source                  = "git::https://github.com/navneetbishnoi/terraform-aws-kms.git?ref=v1.0.0"
  name                    = "kms"
  environment             = "test"
